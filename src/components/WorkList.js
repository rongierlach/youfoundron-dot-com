...
const projects = [
  {
    ...
    description: `
      ...
      <p>Featured in <a class='sans-serif link fw9 black hover-gold' href='https://www.forbes.com/sites/chancebarnett/2017/09/23/inside-the-meteoric-rise-of-icos/'>Forbes</a>.</p>
